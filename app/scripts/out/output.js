...
},{"./navigation":3,"jquery":4}],2:[function(require,module,exports){
/**
 *
 * @class Historical
 * @constructor
...
Historical.prototype = (function () {
    ...
    return {
        ...
        historyEvent: function historyEvent() {},

        popEvent: function popEvent() {},

        windowPopState: function windowPopState() {}
    };
})();
...
Navigation.prototype = (function () {
    ...
    return {
        ...
        fetchHistoryURL: function fetchHistoryURL() {
        ...
        setCurrentClass: function setCurrentClass(className) {
            var $baseList = $(this.list);

            $baseList.first().addClass(className);
        },

        /* Remove the active class from nav links, and reapply to clicked link */
        switchClass: function switchClass(currentLink, className) {
            var $baseList = $(this.list),
...
},{"./historical":2,"jquery":4}],4:[function(require,module,exports){
/*!
